function runA1() {
    ...
    Rectangle.prototype.describe = function(){
        let parentDesc = Shape.prototype.describe.call(this); //i know that gpt call variable same but i think it is really suitable name
        return `${parentDesc} Rectangle ${this.height}x${this.width}`;
    ...
    Square.prototype.describe = function() {
        let parentDesc = Rectangle.prototype.describe.call(this);
